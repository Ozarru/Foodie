...
// import 'courier_deliv_details.dart';

// class CourierDeliveries extends StatefulWidget {
//   const CourierDeliveries({Key? key}) : super(key: key);

//   @override
//   _CourierDeliveriestate createState() => _CourierDeliveriestate();
// }

// class _CourierDeliveriestate extends State<CourierDeliveries> {
//   String query = '';
//   bool isLoading = true;
//   List<TestDelivery> deliveries = localDeliveries;
